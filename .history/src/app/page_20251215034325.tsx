    ...
    <div ref={containerRef} className="relative min-h-[300vh]">
      ...
      <div className="sticky top-0 h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            <Link href="/download" className="group relative px-12 py-5 bg-white text-black rounded-full font-bold text-lg tracking-wide overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-400 via-purple-400 to-blue-400 bg-[length:200%_100%] animate-[shimmer_2s_linear_infinite] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              <span className="relative z-10 flex items-center gap-2 group-hover:scale-105 transition-transform duration-300">
                INITIALIZE CORE <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
              </span>
            </Link>
          </motion.div>
        </motion.div>
              ...
              <div className="relative rounded-[2.9rem] bg-black/20 backdrop-blur-xl border border-white/10 p-12 md:p-24 overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                  ...
                  <div className="max-w-md text-right md:text-left">
                    ...
                    <Link href={item.href} className="mt-8 px-8 py-3 rounded-full border border-white/20 hover:bg-white hover:text-black transition-all font-bold inline-flex items-center gap-2">
