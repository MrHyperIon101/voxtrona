      ...
      <div className="max-w-7xl mx-auto px-4 pb-24">
        ...
        <div className="py-24 flex items-center border-b border-white/5">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative h-[400px] rounded-3xl bg-gradient-to-br from-blue-900/20 to-black border border-white/10 flex items-center justify-center overflow-hidden">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.2),transparent_70%)]" />
              <Waves size={200} className="text-blue-500/20 animate-pulse" />
            </div>
          </div>
        </div>
            ...
            <div className="order-2 md:order-1 relative h-[400px] rounded-3xl bg-gradient-to-br from-purple-900/20 to-black border border-white/10 flex items-center justify-center overflow-hidden">
               <div className="grid grid-cols-2 gap-8 text-center">
                 {['FLAC', 'DSD', 'WAV', 'MQA'].map((fmt) => (
                   <div key={fmt} className="p-6 rounded-2xl bg-white/5 border border-white/10">
                     <span className="text-3xl font-bold text-white/80">{fmt}</span>
                   </div>
                 ))}
               </div>
            </div>
