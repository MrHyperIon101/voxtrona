    ...
    <div className="min-h-screen">
      ...
      <section className="h-[60vh] md:h-[80vh] flex items-center justify-center relative overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] h-[250px] md:w-[600px] md:h-[600px] bg-blue-500/20 rounded-full blur-[40px] md:blur-[100px] md:animate-pulse will-change-transform" />
        </div>
