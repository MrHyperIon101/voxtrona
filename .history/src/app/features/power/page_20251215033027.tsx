      ...
      <section className="h-[80vh] flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            ...
            <p className="text-xl md:text-3xl font-light tracking-[1em] text-yellow-200 uppercase">
              Total Control
            </p>
          </motion.div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-24">
        ...
        <div className="py-24 flex items-center border-b border-white/5">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative h-[400px] rounded-3xl bg-gradient-to-br from-yellow-900/20 to-black border border-white/10 flex items-center justify-center overflow-hidden">
        ...
        <div className="py-24 flex items-center">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1 relative h-[400px] rounded-3xl bg-gradient-to-br from-green-900/20 to-black border border-white/10 flex items-center justify-center overflow-hidden p-8">
