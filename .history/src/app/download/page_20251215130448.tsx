    ...
    <div ref={containerRef} className="relative min-h-[250vh]">
      ...
      <div className="relative z-20 mt-[50vh] pb-32 px-4">
        ...
        <motion.div 
          ...
          className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 mb-32 md:mb-64"
        >
          {/* Android Card */}
          <div className="group relative p-[2px] rounded-[3rem] overflow-hidden">
            ...
            <div className="relative h-full bg-black/80 backdrop-blur-xl rounded-[2.9rem] p-8 md:p-12 overflow-hidden">
              {/* Background Glow */}
              <div className="absolute top-0 right-0 w-64 h-64 md:w-96 md:h-96 bg-green-500/10 blur-[100px] rounded-full translate-x-1/2 -translate-y-1/2 group-hover:bg-green-500/20 transition-colors duration-500" />
