      ...
      <div className="relative z-20 mt-[50vh] pb-32 px-4">
        ...
        >
          ...
          <div className="group relative p-[2px] rounded-[3rem] overflow-hidden">
            ...
            <div className="absolute -inset-[100%] bg-[conic-gradient(from_0deg,transparent_0_340deg,#22c55e_360deg)] animate-[spin_4s_linear_infinite] opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            
            <div className="relative h-full bg-black/80 backdrop-blur-xl rounded-[2.9rem] p-12 overflow-hidden">
              {/* Background Glow */}
              <div className="absolute top-0 right-0 w-96 h-96 bg-green-500/10 blur-[100px] rounded-full translate-x-1/2 -translate-y-1/2 group-hover:bg-green-500/20 transition-colors duration-500" />
          ...
          <div className="group relative p-[2px] rounded-[3rem] overflow-hidden">
            ...
            <div className="relative h-full bg-black/80 backdrop-blur-xl rounded-[2.9rem] p-12 overflow-hidden">
              {/* Background Glow */}
              <div className="absolute top-0 right-0 w-96 h-96 bg-blue-500/10 blur-[100px] rounded-full translate-x-1/2 -translate-y-1/2 group-hover:bg-blue-500/20 transition-colors duration-500" />
