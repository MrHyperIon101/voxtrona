    ...
    <div ref={containerRef} className="relative min-h-[300vh]">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <motion.div 
          ...
          className="absolute top-1/4 left-1/4 w-[250px] h-[250px] md:w-[500px] md:h-[500px] bg-blue-600/5 rounded-full blur-[40px] md:blur-[100px] will-change-transform"
        />
        <motion.div 
          animate={{ 
            scale: [1, 1.5, 1],
          ...
          className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] md:w-[600px] md:h-[600px] bg-purple-600/5 rounded-full blur-[50px] md:blur-[120px] will-change-transform"
        />
      </div>
      ...
      <div className="relative z-20 mt-[30vh] md:mt-[50vh] pb-32 px-4">
