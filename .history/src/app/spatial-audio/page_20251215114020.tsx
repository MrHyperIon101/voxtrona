        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center justify-items-center opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            <div className="flex items-center gap-2 group/logo">
              <svg className="h-8 w-auto text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                 <path d="M2 12h3l3-6 4 12 3-6h7" />
              </svg>
              <span className="text-3xl font-bold tracking-[0.2em] text-white">DIRAC</span>
            </div>
