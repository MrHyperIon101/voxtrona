    ...
    <div className="min-h-screen">
      ...
      <section className="py-12 border-y border-white/5 bg-white/5 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center justify-items-center opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
            {/* Dolby Atmos */}
            ...
            {/* Dirac Live */}
            <div className="flex items-center gap-3 group/logo">
              <svg className="h-8 w-auto text-white" viewBox="0 0 120 40" fill="currentColor">
                <text x="0" y="32" fontFamily="Arial, sans-serif" fontWeight="900" fontSize="32" letterSpacing="2">DIRAC</text>
              </svg>
              <span className="text-3xl font-light tracking-widest text-blue-400">LIVE</span>
            </div>
