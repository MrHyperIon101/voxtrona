    ...
    <div ref={containerRef} className="relative min-h-[300vh]">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <motion.div 
          ...
          className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[100px]"
        />
        <motion.div 
          animate={{ 
            scale: [1, 1.5, 1],
        ...
        >
          ...
          >
            <div className="flex items-center gap-3 px-6 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md">
              ...
              <span className="text-sm font-medium tracking-widest uppercase text-gray-300">System Online</span>
            </div>
          </motion.div>
          ...
          >
            <Link href="/download" className="group relative px-12 py-5 bg-white text-black rounded-full font-bold text-lg tracking-wide overflow-hidden hover:scale-105 transition-transform">
      ...
      <div className="relative z-20 mt-[50vh] pb-32 px-4">
              ...
              <div className="relative rounded-[2.9rem] bg-black/20 backdrop-blur-xl border border-white/10 p-12 md:p-24 overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                  ...
                  <div className="max-w-md text-right md:text-left">
                    ...
                    <button className="mt-8 px-8 py-3 rounded-full border border-white/20 hover:bg-white hover:text-black transition-all font-bold flex items-center gap-2">
        ...
        <div className="mt-64 text-center pb-48">
          <h2 className="text-[10vw] font-black text-white/10 tracking-tighter leading-none select-none">
            READY?
          </h2>
