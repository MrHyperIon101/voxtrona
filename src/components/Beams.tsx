...
const CanvasWrapper: FC<{ children: ReactNode; dpr?: number | [number, number]; frameloop?: 'always' | 'demand' }> = ({ children, dpr = [1, 2], frameloop = 'always' }) => (
  <Canvas dpr={dpr as any} frameloop={frameloop as any} className="beams-container">
    {children}
  </Canvas>
);
  ...
  return (
    <CanvasWrapper dpr={dpr} frameloop={frameloop}>
      <group rotation={[0, 0, degToRad(rotation)]}>
        <PlaneNoise ref={meshRef} material={beamMaterial} count={beamNumber} width={beamWidth} height={beamHeight} heightSegments={heightSegments} paused={paused} speed={speed} />
...
>(({ material, width, count, height, heightSegments, paused, speed }, ref) => {
