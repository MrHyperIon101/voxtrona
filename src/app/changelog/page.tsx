...
export default function ChangelogPage() {
  const [expandedVersions, setExpandedVersions] = useState<string[]>(["v2.2.2026", "v1.5.0"]);
                  ...
                  <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
                    ...
                    <div className="shrink-0 flex md:flex-col items-center gap-4 md:gap-2 min-w-[120px]">
                      ...
                      <div className="text-center">
                        ...
                        <div className={`text-[10px] font-bold uppercase tracking-widest mt-1 ${release.status === 'BETA' ? 'text-yellow-400' : 'text-green-400'
                          }`}>
                          {release.status}
                        </div>
                      </div>
                          ...
                          <div className="mt-10 pt-8 border-t border-white/5 flex justify-center w-full">
                            ...
                            >
                              <div className="relative z-10 text-left">
                                ...
                                <p className="text-sm text-green-400 font-bold">47 MB • Official Release</p>
                              </div>
