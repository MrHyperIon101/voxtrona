                     ...
                     <div className="relative p-6 md:p-8 rounded-[15px] bg-black/80 backdrop-blur-xl flex flex-col md:flex-row gap-6 md:items-center">
                        ...
                        <div className="flex-1">
                           <div className="flex items-center gap-3 mb-2">
                              ...
                              <span className="text-gray-500 text-sm">Jan 1, 2026</span>
                           </div>
                           <h3 className="text-xl font-bold text-white mb-2 group-hover:text-green-400 transition-colors">Voxtrona Android v2.2.2026 Released</h3>
                  ...
                  >
                     <div className="relative p-6 md:p-8 rounded-[15px] bg-black/20 backdrop-blur-xl flex flex-col md:flex-row gap-6 md:items-center">
                        ...
                        <div className="flex-1">
                           ...
                           <h3 className="text-xl font-bold text-white mb-2">40,000+ Active Users</h3>
                           <p className="text-gray-400">
