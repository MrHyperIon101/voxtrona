...
import { AlertTriangle, Mail, Smartphone, Terminal, Bug, CheckCircle2, ChevronRight, Image as ImageIcon, X } from "lucide-react";
...
export default function ReportBugPage() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    setTimeout(() => {
        setSubmitting(false);
        setSuccess({ id: "BUG-" + Math.floor(Math.random() * 10000), createdAt: new Date().toISOString() });
    }, 1500);
  }
        ...
        <div className="grid lg:grid-cols-[1fr_400px] gap-12 lg:gap-24">
            ...
            <div className="hidden lg:block space-y-6 pt-20">
                <div className="sticky top-32">
                    ...
                    <div className="mt-8 p-6 rounded-3xl bg-linear-to-br from-blue-500/20 to-purple-500/20 border border-white/10 text-center">
                        <Mail className="mx-auto text-white mb-4" size={32} />
                        <h4 className="font-bold text-white mb-2">Need Urgent Help?</h4>
                        <p className="text-sm text-gray-300 mb-4">Join our Discord for real-time support from the community.</p>
                        <a href="https://discord.gg/" className="text-sm font-bold text-white border-b border-white pb-0.5 hover:text-blue-200 hover:border-blue-200 transition-colors">Join Discord Server</a>
                    </div>
                </div>
            </div>
